              ...
              <Wrapper dr={`row`} ju={`space-between`}>
                ...
                <Wrapper width={width < 700 ? `100%` : `48%`} al={`flex-start`}>
                  ...
                  <Text
                    ...
                    color={Theme.subTheme10_C}
                  >
                    신체적, 정신적 자존감을 회복시킬 수 있는 최적의 장소입니다.
                  </Text>
                </Wrapper>
              </Wrapper>
              <Wrapper
              ...
              >
                <Wrapper width={width < 700 ? `100%` : `48%`} al={`flex-start`}>
                  <Text
                    ...
                    color={Theme.subTheme10_C}
                  >
                    정식 '간호사'와 '영양사'가 어르신들을 위해 맞춤 의료서비스와
                  </Text>
                  <Text
                    fontSize={width < 700 ? `18px` : `20px`}
                    fontWeight={`bold`}
                  ...
                  <Text fontSize={width < 700 ? `18px` : `20px`}>
                    프로그램을 일반형, 치매특화형 프로그램으로 분리하여 운영하고
                    있습니다. 
                  </Text>
                </Wrapper>
                <Image
          ...
          >
            <RsWrapper>
              <Wrapper dr={`row`}>
                ...
                >
                  <Text>
                    “孝를 실천하는 아름다운 사람들”이라는 원훈에 따라 어르신들께
                    가족같은 마음으로 서비스를 제공하고,
                  </Text>
                  <Text>
                  ...
                  <Text>
                    보호자 욕구에 맞는 최고의 서비스를 제공해 심리.사회적 안정을
                    지원하겠습니다.
                  </Text>
